...
<html>
	<head>
		...
		<title>Full Width | Porto - Responsive HTML5 Template 4.8.0</title>	
						...
						<div class="header-row">
							<div class="header-column">
								<div class="header-logo">
									<a href="index.html">
										<img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?php echo base_url(); ?>assets/frontend/img/logo.png">
									</a>
								</div>
							</div>
							<div class="header-column">
